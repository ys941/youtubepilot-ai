...
const DEFAULT_PROMPT_HINTS: Record<string, string> = {
  ...
  PRO_TIP:   "Create a PRO TIP: one high-yield, immediately actionable insight (bold on the card), caption gives the reasoning + supporting evidence + practical application. 150-200 words.",
  ...
  IMAGE_QUIZ: "Create an IMAGE QUIZ: describe a visual finding on the card, A/B/C/D options, a correct-answer reveal, and a short explanation. 150-200 words.",
  KNOWLEDGE_QUIZ:         "Create a KNOWLEDGE QUIZ: pose a question on the card, 4 options A-D, a 'Drop your answer below!' CTA, and an explanation of the correct answer. 150-200 words.",
